          ...
          if (file.type === "application/pdf") {
            ...
            try {
              ...
              if (textContent.length < 50) {
                throw new Error("PDF appears to be empty or image-based. Please ensure it contains readable text.");
              }
              ...
              if (textContent.length < 50) {
                throw new Error("Could not extract readable text from PDF. Please try a different file or save as text format.");
              }
            ...
            if (textContent.length < 50) {
              throw new Error("Text file appears to be too short or empty.");
            }
